...
//        );
        ...
        vo.setNonceStr(String.valueOf(System.currentTimeMillis()));
    ...
    public void paySuccess(String outTradeNo) {
        ...
        // 检查订单是否存在
        if (ordersDB == null) {
            log.error("支付回调失败：未找到订单，orderNumber={}, userId={}", outTradeNo, userId);
            return;
        }
    ...
    public PageResult pageQuery4User(int pageNum, int pageSize, Integer status) {
        ...
        OrdersPageQueryDTO ordersPageQuery = new OrdersPageQueryDTO();
        ordersPageQuery.setUserId(BaseContext.getCurrentId());
        ordersPageQuery.setStatus(status);
